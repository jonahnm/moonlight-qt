...
pushd $BUILD_FOLDER
# EXTRA_QMAKE_FLAGS can be used to opt into optional features, e.g. "CONFIG+=pyrowave"
qmake $SOURCE_ROOT/moonlight-qt.pro QMAKE_APPLE_DEVICE_ARCHS="x86_64 arm64" $EXTRA_QMAKE_FLAGS || fail "Qmake failed!"
popd
